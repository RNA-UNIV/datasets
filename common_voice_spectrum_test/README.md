...
X, y, clases, _ = DataLoader.load_images('common_voice_spectrum_test', resize=(65, 64))
```
...
X_test, y_test = load_spectrogram_dataset('datasets/common_voice_spectrum_test/')
print(f"Espectrogramas cargados: {X_test.shape}")
```
